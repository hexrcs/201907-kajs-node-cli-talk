...
<Head>
  ...
  <meta
    name="twitter:image"
    content="https://talks.xiaoru.li/201907-kajs-node-cli-talk/slides/cover.png"
  />
  <link
    rel="stylesheet"
...
### But layouts in a pure text environment is still tough <Emoji svg text="😕" />
...
## They sure don't look like well polished to me <Emoji svg text="😅" />
...
Flag the entrance JS file an executable
